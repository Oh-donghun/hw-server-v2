...
- 절대 규칙: 현재 연도는 ${currentYear}년이다. ${currentYear-1}년 이전은 이미 지나간 해다. 지나간 해에 대해 "조심해라", "주의해라" 등 미래형 조언을 절대 하지 마라.
- 과거 해의 운세는 반드시 과거형("~했다", "~였다")으로만 서술해라.
- 시기 관련 조언(이사, 투자, 이직 등)은 반드시 ${currentYear}년 이후만 제시해라.
- ch8_years의 year 값은 반드시 ${currentYear}, ${currentYear+1}, ${currentYear+2}만 사용해라.
